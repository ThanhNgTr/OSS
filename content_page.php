	...
	if (isset($_GET['content'])) {
		switch ($_GET['content']) {
            ...
            case "showarr":
                $_id=$_GET['id'];
                include("./BaiTapTH/MCH/$_id");
                break;
            case "showabt":
                $_id=$_GET['id'];
                include("./BaiTapTH/PHPvaForm/$_id");
                break;
            case "showasq":
                $_id=$_GET['id'];
                include("./BaiTapTH/SQL/Bai2/$_id");
                break;
            case "chanp":
	...
	?>
				...
				<div class="sanphamcon">
					...
					while ($result = mysqli_fetch_array($query)) { ?>
						<div class="dienthoai">
							...
							<?php } ?>
							<a href="index.php?content=chitietsp&idsp=<?php echo $rows['idsp'] ?>"><img src=" img/uploads/<?php echo $result['hinhanh']; ?>"></a>
							<p><a href="index.php?content=chitietsp&idsp=<?php echo $rows['idsp'] ?>"><?php echo $result['tensp']; ?></a></p>
			...
			<div class="phantrang">
				...
				$total_results = mysqli_fetch_array(mysqli_query($link, "SELECT COUNT(*) as Num FROM sanpham where madm='{$_GET['madm']}'"), 0);
