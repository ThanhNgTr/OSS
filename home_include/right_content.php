						...
						<?php if(isset( $_SESSION['username'])){
							?>
								...
								<span id="xinchao"><p>Xin chào: <span> <?php echo $_SESSION['username'] ?> </span></p></span>
                                    <ul>
                                        <li><a href="index.php?content=chanp&idus=<?php echo $_SESSION['idnd']?>">Đổi mật khẩu</a></li>
                                        <li><a href="logout.php">Đăng xuất</a></li>
                                    </ul>
<!--                                    <span id="logout"><p><a href="">Doi mat khau</a></p></span>-->
<!--								    <span id="logout"><p><a href="">Logout</a></p></span>-->
						</div><!-- End .dangnhap-in-->
							<?php 
						}
						else{
						...
						<div id="dangnhap-in">
							...
							<ul>
                                ...
                                <li><a href="index.php?content=quenmk">Quên mật khẩu?</a></li>
							</ul>
