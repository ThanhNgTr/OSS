<?php
$sql = "select * from danhmuc where dequi=3 order by madm";
...
?> <div class="sanpham"> <?php
            ...
            <div id="xemthem">
                <p><a href="index.php?content=danhmucsp&madm=<?php echo $row['madm'] ?>">Xem thêm >></a></p>
            </div>
        <?php } ?>
                ...
                <div class="dienthoai">
                    ...
                    <div class="button">
                        <ul>
                            ...
                            ?>
                                <li>
                                    <h5><a href="index.php?content=cart&action=add&idsp=<?php echo $rows['idsp'] ?>"><button>Cho vao gio</button></a></h5>
                                </li>
                            <?php }
                            ?>
                        </ul>
